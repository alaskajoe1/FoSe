...
def animate(i):
    global maxForce, exercise, countdown, pause, startTime, started, finished, endTimer
...
def graphReset():
    global startTime, pause, maxForce, countdown, started, finished, ignoreOnReset
