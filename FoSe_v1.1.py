...
def helpScreen():
    ...
    # loads help image
    help_image = tk.PhotoImage(file="file.png")
    helpLabel = tk.Label(helpScreen, image=help_image)
    helpLabel.image = help_image
    helpLabel.pack()

    # button to exit the window
    B1 = ttk.Button(helpScreen, text="Okay", command=helpScreen.destroy)
    B1.pack()
    helpScreen.mainloop()
...
ani = animation.FuncAnimation(fig, animate, interval=24)
app.mainloop()
